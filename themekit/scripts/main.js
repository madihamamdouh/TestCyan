...
function pauseAll(elem,elem2)
{
    var bunnyVideo = document.getElementById(elem);
    var s = '';
	...
	for(var i=0; i<videos.length; i++)
    {
		...
		videos[i].pause();
     document.getElementById('avideov'+i).classList.add('btn-video');
  }
    if (s == 'p') {
        bunnyVideo.play();
        document.getElementById(elem2).classList.remove('btn-video');
    } else {
        bunnyVideo.pause();
        document.getElementById(elem2).classList.add('btn-video');
    }
};
// const videosAll = document.querySelectorAll('.video');
...
//      const videoOne = document.getElementsByClassName('.videoOne');
//      if(videoOne.paused){
//           videoOne.play();}
//           else{
//                videoOne.pause();
